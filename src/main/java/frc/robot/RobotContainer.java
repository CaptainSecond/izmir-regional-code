...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(f310, 3).whileHeld(new TunnelCommand(tunnel, -1));

    // Trigger
    new JoystickButton(f310, 4).whileHeld(new TriggerCommand(trigger, 1));
    new JoystickButton(f310, 1).whileHeld(new TriggerCommand(trigger, 1));
